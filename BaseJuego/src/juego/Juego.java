...
public class Juego extends Canvas implements KeyListener{
	...
	private Auto jugador;//Instancia del jugador
	...
	public Juego(){
		...
		dobleBuffer = this.getBufferStrategy(); //Obtener una instancia de BufferStrategy (para luego dibujar los componentes)
	...
	private void pintar(){
        ...
        //Pintar el auto
        jugador.pintar(g2D, imagenes.get(jugador.getImagen()), this);
	...
	public void cicloPrincipal(){
       ...
       while (jugando){
    	   ...
    	   //Aplicar la pausa en cada iteracion.
